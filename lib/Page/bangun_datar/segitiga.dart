    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            MyTextfield(
                text: "", label: "Sisi 1", controller: _Value1),
            MyTextfield(
                text: "", label: "Sisi 2", controller: _Value2),
            MyTextfield(
                text: "", label: "Sisi 3", controller: _Value3),
            MyTextbutton(
              text: "Hitung",
              onPressed: () {
              ...
              StoreProvider.of<StateBangunDatar>(context).dispatch(CalculateTriangleValue(sisi1,sisi2,sisi3));
              },
